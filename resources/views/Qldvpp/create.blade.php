...
<h3>Thêm Đơn vị Phân phối</h3>
<br>
<form action="{{ route('donviphanphoi.store') }}" method="post">
    @csrf
    <div class="form-group row">
        <label class="col-sm-1,5 col-form-label flex-div"><strong> Mã Đơn vị phân phối: </strong></label>
        <div class="col-sm-5">
          <input type="text" class="form-control" name="MaDonViPhanPhoi" placeholder="Nhập Mã Đơn vị phân phối...">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" name="TenDonViPhanPhoi" placeholder="Nhập Tên đơn vị phân phối...">
    ...
    <br>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="tel" class="form-control" name="SoDienThoai" placeholder="Nhập Số điện thoại...">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="tel" class="form-control" name="Fax" placeholder="Nhập FAX...">
          @if ($errors->has('Fax'))
          <span class="error" style="color: red;">
              {{ $errors->first('Fax') }}
          </span>
