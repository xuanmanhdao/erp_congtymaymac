...
<h3>Sửa chức vụ: {{ $data->MaChucVu }}</h3>
<br>
<form action="{{ route('chucvu.update',$data) }}" method="post">
  @method('PUT')
    @csrf
 {{--    <div class="form-group row">  // tăng dần
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input disabled type="text" class="form-control" name="MaChucVu" value="{{ $data->MaChucVu }}">
...
function format_curency(a) {
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input  type="text" class="form-control" name="TenChucVu" value="{{ $data->TenChucVu }}">
    ...
    <br>
      ...
      <div class="form-group row">
        ...
        <textarea name="MoTaChucVu" cols="55" rows="4" >{{ $data->MoTaChucVu }}</textarea>
