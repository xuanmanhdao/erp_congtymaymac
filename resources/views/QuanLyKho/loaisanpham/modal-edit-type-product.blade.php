<div class="modal fade" id="updateTypeProduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="updateProductLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="{{ route('loaisanpham.update', 0) }}" method="post" id="form-edit-type-product">
            @csrf
            @method('PUT')
            ...
            <div class="modal-content">
                <div class="modal-header pb-0">
                    <div>
                        <h1 class="modal-title fs-5" id="updateProductLabel">Sửa loại sản phẩm</h1>
                        <div class="modal-tab">
                    ...
                    <div class="row justify-content-between tab-content tab-active" data-label="tab-info">
                        <div class="col-lg-5">
                            <div class="modal-input">
                                ...
                                <input type="text" placeholder="Điền mã loại sản phẩm" id="SuaMaLoai" name="MaLoai"
                                    @if ($errors->has('MaLoai')) style="border: 2px solid red;" @endif readonly>
                            </div>
                        ...
                        <div class="col-lg-5">
                            <div class="modal-input">
                                ...
                                <input type="text" placeholder="Điền tên loại sản phẩm" id="SuaTenLoai"
                                    name="TenLoai"
                        ...
                        <div class="col-lg-5">
                            <div class="modal-input">
                                ...
                                <select id="SuaViTriXep" class="form-select" aria-label="Default select example"
                                    name="ViTriXep"
