...
<h3>Thêm xưởng</h3>
<br>
<form action="{{ route('xuong.store') }}" method="post">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" name="TenXuong" placeholder="Nhập Tên xưởng...">
    ...
    <br>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="tel" class="form-control" name="MoTaXuong" placeholder="Nhập  mô tả xưởng...">
